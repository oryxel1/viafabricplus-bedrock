...
package com.viaversion.viafabricplus.bedrock.features.customblock.baker;
...
public class BlockModelBaker {
    public static QuadCollection bake(final ModelBaker modelBaker, final BedrockGeometryModel model, final TextureSlots textures, int lightEmission, CustomBlockCache.Transformation transformation) {
    ...
    public static BakedQuad bakeQuad(final ModelBaker modelBaker,
        ...
        BakedQuad.MaterialInfo materialInfo = interner.materialInfo(BakedQuad.MaterialInfo.of(material, transparency, -1, facing, lightEmission));
